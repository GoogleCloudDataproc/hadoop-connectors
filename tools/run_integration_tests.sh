...
#
# tools/run_integration_tests.sh (hadoop1 | hadoop2) <project_id> <clinet id> <client secret> <service_account_email> <path_to_p12>
...
print_usage() {
  echo -n "$0 (hadoop1 | hadoop2) <project ID> <client ID> <client secret> <service_account_email> <path_to_p12>"
}
