...
#
# tools/run_integration_tests.sh (hadoop1 | hadoop2) <project_id> <service_account_email> <path_to_p12>
...
print_usage() {
  echo -n "$0 (hadoop1 | hadoop2) <project ID> <service_account_email> <path_to_p12>"
}
