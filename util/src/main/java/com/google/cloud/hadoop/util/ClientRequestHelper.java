...
public class ClientRequestHelper<S> {
  ...
  public HttpHeaders getRequestHeaders(AbstractGoogleClientRequest<S> clientRequest) {
    return clientRequest.getRequestHeaders();
  }

  /** Wraps AbstractGoogleClientRequest.getMediaHttpUploader(). */
  public void setChunkSize(AbstractGoogleClientRequest<S> clientRequest, int chunkSize) {
   ...
   */
  public void setDirectUploadEnabled(AbstractGoogleClientRequest<S> clientRequest, boolean enable) {
