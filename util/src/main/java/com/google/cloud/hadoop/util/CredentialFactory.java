...
public class CredentialFactory {
  ...
  @VisibleForTesting
  CredentialFactory(CredentialOptions options, Supplier<HttpTransport> transport) {
   ...
   *     be created
   */
  public GoogleCredentials getCredential() throws IOException, GeneralSecurityException {
  ...
  private GoogleCredentials configureCredentials(GoogleCredentials credentials) {
    ...
    if (credentials instanceof ServiceAccountCredentials) {
      return ((ServiceAccountCredentials) credentials)
          .toBuilder()
          .setTokenServerUri(URI.create(options.getTokenServerUrl()))
          .build();
    }
