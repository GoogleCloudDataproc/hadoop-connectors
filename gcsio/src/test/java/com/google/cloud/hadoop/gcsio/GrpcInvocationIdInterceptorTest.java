...
public class GrpcInvocationIdInterceptorTest {

  private GrpcChannelInvocationIdInterceptor invocationIdInterceptor;
  ...
  public void setUp() throws Exception {
    invocationIdInterceptor = new GrpcChannelInvocationIdInterceptor();
  ...
  public void examineInvocationIdHeader() {
    ...
    assertThat(call.headers.get(GrpcChannelInvocationIdInterceptor.GOOG_API_CLIENT))
        .contains(GrpcChannelInvocationIdInterceptor.GCCL_INVOCATION_ID);
  }
  ...
  public void invocationIdAppendedToExistingHeader() {
    ...
    header.put(GrpcChannelInvocationIdInterceptor.GOOG_API_CLIENT, dummyHeaderValue);
    // start() on the intercepted call will eventually reach the call created by the real channel
