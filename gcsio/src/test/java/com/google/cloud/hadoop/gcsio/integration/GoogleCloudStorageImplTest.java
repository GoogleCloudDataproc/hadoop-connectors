...
public class GoogleCloudStorageImplTest {
  ...
  //       .containsExactly(
  //           uploadRequestString(
  //               resourceId.getBucketName(), resourceId.getObjectName(), /* generationId= */
  // null));
  //   trackingGcs.delegate.close();
  // }
  //
  ...
  //
  //   assertThat(
  //           helperGcs.getItemInfos(ImmutableList.of(resourceId1, resourceId2,
  // resourceId3)).stream()
  ...
  //   byte[] partition =
  //       writeObject(helperGcs, resourceId, /* partitionSize= */ 64 * 1024 * 1024,
  // partitionsCount);
  //
