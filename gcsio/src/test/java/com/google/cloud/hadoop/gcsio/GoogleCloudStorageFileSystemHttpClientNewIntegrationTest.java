...
/**
 * Test suites of integration tests for {@link GoogleCloudStorageFileSystem} class configured to use
 * Apiary client to connect to gcs server.
 */
...
public class GoogleCloudStorageFileSystemHttpClientNewIntegrationTest
  ...
  protected GoogleCloudStorageFileSystem newGcsFs(
      GoogleCloudStorageFileSystemOptions gcsfsOptions,
      TrackingHttpRequestInitializer gcsRequestsTracker)
      throws IOException {
    return new GoogleCloudStorageFileSystem(
        options -> new GoogleCloudStorageImpl(options, gcsRequestsTracker), gcsfsOptions);
  }
}
