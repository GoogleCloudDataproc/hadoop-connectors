...
public class GoogleCloudStorageItemInfoIntegrationTest {
  ...
  @Test
  public void getModificationTime_changeForDirectoryWenMetadataAdded() throws Exception {
    String directoryObjectName = "test-modification-timestamps/create-dir/";
    String bucketName = gcsfsIHelper.sharedBucketName1;

    URI directory = gcsfsIHelper.getPath(bucketName, directoryObjectName);
    ...
    StorageResourceId resourceId =
        new StorageResourceId(bucketName, directoryObjectName);
