...
public final class Channel extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key private String address;
   ...
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString private Long expiration;
   ...
   * null}.
   */
  @com.google.api.client.util.Key private java.util.Map<String, String> params;

  /**
   * A Boolean value to indicate whether payload is wanted. Optional. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private Boolean payload;
  ...
  @com.google.api.client.util.Key private String resourceUri;
   ...
   */
  @com.google.api.client.util.Key private String token;
