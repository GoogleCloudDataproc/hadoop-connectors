...
public final class HmacKey extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The kind of item this is. For HMAC keys, this is always storage#hmacKey. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private String kind;

  /** Key metadata. The value may be {@code null}. */
  @com.google.api.client.util.Key private HmacKeyMetadata metadata;

  /** HMAC secret key material. The value may be {@code null}. */
  @com.google.api.client.util.Key private String secret;
   ...
   */
  public HmacKey setKind(String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public HmacKey setSecret(String secret) {
    this.secret = secret;
    return this;
  }
