...
public final class Buckets extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<com.google.api.services.storage.model.Bucket> items;

  static {
    // hack to force ProGuard to consider Bucket used, since otherwise it would be stripped out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(com.google.api.services.storage.model.Bucket.class);
  }

  /**
   * The kind of item this is. For lists of buckets, this is always storage#buckets. The value may
   * be {@code null}.
   */
   ...
   */
  public java.util.List<com.google.api.services.storage.model.Bucket> getItems() {
    return items;
  }
