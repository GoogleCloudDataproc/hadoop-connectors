...
public final class RewriteResponse extends com.google.api.client.json.GenericJson {
   ...
   * always present in the response. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private Boolean done;
   ...
   * response. The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString private Long objectSize;

  /**
   * A resource containing the metadata for the copied-to object. This property is present in the
   * response only when copying completes. The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private com.google.api.services.storage.model.StorageObject resource;

  /**
   * A token to use in subsequent requests to continue copying data. This token is present in the
   * response only when there is more data to copy. The value may be {@code null}.
   */
   ...
   * indicator. This property is always present in the response. The value may be {@code null}.
   */
   ...
   */
  public RewriteResponse setDone(Boolean done) {
    this.done = done;
    return this;
  }
   ...
   */
  public RewriteResponse setKind(String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public RewriteResponse setObjectSize(Long objectSize) {
   ...
   * @return value or {@code null} for none
   */
  public com.google.api.services.storage.model.StorageObject getResource() {
    return resource;
  }
   ...
   */
  public RewriteResponse setRewriteToken(String rewriteToken) {
   ...
   */
  public RewriteResponse setTotalBytesRewritten(Long totalBytesRewritten) {
