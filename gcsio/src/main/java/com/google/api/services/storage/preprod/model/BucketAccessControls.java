...
public final class BucketAccessControls extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<com.google.api.services.storage.model.BucketAccessControl> items;

  static {
    // hack to force ProGuard to consider BucketAccessControl used, since otherwise it would be
    // stripped out
   ...
   * storage#bucketAccessControls. The value may be {@code null}.
   */
   ...
   */
  public java.util.List<com.google.api.services.storage.model.BucketAccessControl> getItems() {
    return items;
  }
