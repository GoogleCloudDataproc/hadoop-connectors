...
public final class ObjectAccessControl extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The content generation of the object, if applied to an object. The value may be {@code null}.
   */
   ...
   * storage#objectAccessControl. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private String kind;

  /** The name of the object, if applied to an object. The value may be {@code null}. */
   ...
   */
  public ObjectAccessControl setObject(String object__) {
