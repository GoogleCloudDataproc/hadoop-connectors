...
public final class TestIamPermissionsResponse extends com.google.api.client.json.GenericJson {
   ...
   * bucket metadata. - storage.objects.delete — Delete object. - storage.objects.get — Read object
   * data and metadata. - storage.objects.getIamPolicy — Read object IAM policy. -
   ...
   * object metadata. The value may be {@code null}.
   */
   ...
   */
  public TestIamPermissionsResponse setKind(String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public TestIamPermissionsResponse setPermissions(java.util.List<String> permissions) {
