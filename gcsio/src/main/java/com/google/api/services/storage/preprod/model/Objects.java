...
public final class Objects extends com.google.api.client.json.GenericJson {
  ...
  @com.google.api.client.util.Key private java.util.List<StorageObject> items;

  static {
    // hack to force ProGuard to consider StorageObject used, since otherwise it would be stripped
    // out
  ...
  /**
   * The kind of item this is. For lists of objects, this is always storage#objects. The value may
   * be {@code null}.
   */
   ...
   * delimiter. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<String> prefixes;
   ...
   */
  public Objects setPrefixes(java.util.List<String> prefixes) {
