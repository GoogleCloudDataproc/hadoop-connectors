...
public final class Bucket extends com.google.api.client.json.GenericJson {
  ...
  /** Access controls on the bucket. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<BucketAccessControl> acl;

  /** The bucket's Autoclass configuration. The value may be {@code null}. */
  @com.google.api.client.util.Key private Autoclass autoclass;

  /** The bucket's billing configuration. The value may be {@code null}. */
  @com.google.api.client.util.Key private Billing billing;

  /**
   * The bucket's Cross-Origin Resource Sharing (CORS) configuration. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<Cors> cors;
   ...
   * or archived until the hold is removed. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private Boolean defaultEventBasedHold;

  /**
   * Default access controls to apply to new objects when no ACL is provided. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<ObjectAccessControl> defaultObjectAcl;

  /** Encryption configuration for a bucket. The value may be {@code null}. */
  @com.google.api.client.util.Key private Encryption encryption;

  /** HTTP 1.1 Entity tag for the bucket. The value may be {@code null}. */
  @com.google.api.client.util.Key private String etag;

  /** The bucket's IAM configuration. The value may be {@code null}. */
  @com.google.api.client.util.Key private IamConfiguration iamConfiguration;

  /**
   * The ID of the bucket. For buckets, the id and name properties are the same. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private String id;

  /**
   * The kind of item this is. For buckets, this is always storage#bucket. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private String kind;

  /** User-provided labels, in key/value pairs. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.Map<String, String> labels;

  /**
   * The bucket's lifecycle configuration. See lifecycle management for more information. The value
   * may be {@code null}.
   */
  @com.google.api.client.util.Key private Lifecycle lifecycle;

  /**
   * The location of the bucket. Object data for objects in the bucket resides in physical storage
   * within this region. Defaults to US. See the developer's guide for the authoritative list. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private String location;

  /** The type of the bucket location. The value may be {@code null}. */
  @com.google.api.client.util.Key private String locationType;

  /**
   * The bucket's logging configuration, which defines the destination bucket and optional name
   * prefix for the current bucket's logs. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private Logging logging;

  /** The metadata generation of this bucket. The value may be {@code null}. */
  ...
  /**
   * The owner of the bucket. This is always the project team's owner group. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private Owner owner;

  /** The project number of the project the bucket belongs to. The value may be {@code null}. */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
   ...
   * retention policy will result in a PERMISSION_DENIED error. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private RetentionPolicy retentionPolicy;

  /**
   * The Recovery Point Objective (RPO) of this bucket. Set to ASYNC_TURBO to turn on Turbo
   * Replication on a bucket. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private String rpo;

  /** Reserved for future use. The value may be {@code null}. */
  @com.google.api.client.util.Key private Boolean satisfiesPZS;

  /** The URI of this bucket. The value may be {@code null}. */
   ...
   * created, it will default to STANDARD. For more information, see storage classes. The value may
   * be {@code null}.
   */
  @com.google.api.client.util.Key private String storageClass;

  /** The creation time of the bucket in RFC 3339 format. The value may be {@code null}. */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime timeCreated;

  /** The modification time of the bucket in RFC 3339 format. The value may be {@code null}. */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime updated;

  /** The bucket's versioning configuration. The value may be {@code null}. */
  @com.google.api.client.util.Key private Versioning versioning;

  /**
   * The bucket's website configuration, controlling how the service behaves when accessing bucket
   * contents as a web site. See the Static Website Examples for more information. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private Website website;
   ...
   */
  public Bucket setDefaultEventBasedHold(Boolean defaultEventBasedHold) {
   ...
   */
  public Bucket setLabels(java.util.Map<String, String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   */
  public Bucket setLocationType(String locationType) {
   ...
   */
  public Bucket setRpo(String rpo) {
    this.rpo = rpo;
    return this;
  }
   ...
   */
  public Bucket setSatisfiesPZS(Boolean satisfiesPZS) {
  ...
  public static final class Autoclass extends com.google.api.client.json.GenericJson {
    ...
    /** Whether or not Autoclass is enabled on this bucket The value may be {@code null}. */
    @com.google.api.client.util.Key private Boolean enabled;

    /**
     * A date and time in RFC 3339 format representing the instant at which "enabled" was last
     * toggled. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private com.google.api.client.util.DateTime toggleTime;
     ...
     */
    public Autoclass setEnabled(Boolean enabled) {
  ...
  public static final class Billing extends com.google.api.client.json.GenericJson {
    ...
    /**
     * When set to true, Requester Pays is enabled for this bucket. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private Boolean requesterPays;
     ...
     */
    public Billing setRequesterPays(Boolean requesterPays) {
  ...
  public static final class Cors extends com.google.api.client.json.GenericJson {
     ...
     * responses. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private Integer maxAgeSeconds;

    /**
     * The list of HTTP methods on which to include CORS response headers, (GET, OPTIONS, POST, etc)
     * Note: "*" is permitted in the list of methods, and means "any method". The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key private java.util.List<String> method;

    /**
     * The list of Origins eligible to receive CORS response headers. Note: "*" is permitted in the
     * list of origins, and means "any Origin". The value may be {@code null}.
     */
    @com.google.api.client.util.Key private java.util.List<String> origin;

    /**
     * The list of HTTP headers other than the simple response headers to give permission for the
     * user-agent to share across domains. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private java.util.List<String> responseHeader;
     ...
     */
    public Cors setMaxAgeSeconds(Integer maxAgeSeconds) {
     ...
     */
    public Cors setMethod(java.util.List<String> method) {
      this.method = method;
      return this;
    }
     ...
     */
    public Cors setOrigin(java.util.List<String> origin) {
      this.origin = origin;
      return this;
    }
     ...
     * @return value or {@code null} for none
     */
    public java.util.List<String> getResponseHeader() {
     ...
     */
    public Cors setResponseHeader(java.util.List<String> responseHeader) {
  ...
  public static final class Encryption extends com.google.api.client.json.GenericJson {
     ...
     * encryption method is specified. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private String defaultKmsKeyName;
     ...
     */
    public Encryption setDefaultKmsKeyName(String defaultKmsKeyName) {
  ...
  public static final class IamConfiguration extends com.google.api.client.json.GenericJson {
     ...
     * uniformBucketLevelAccess field to enable and disable the feature. The value may be {@code
     * null}.
     */
    @com.google.api.client.util.Key private BucketPolicyOnly bucketPolicyOnly;

    /**
     * The bucket's Public Access Prevention configuration. Currently, 'inherited' and 'enforced'
     * are supported. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private String publicAccessPrevention;

    /** The bucket's uniform bucket-level access configuration. The value may be {@code null}. */
    @com.google.api.client.util.Key private UniformBucketLevelAccess uniformBucketLevelAccess;
     ...
     */
    public IamConfiguration setPublicAccessPrevention(String publicAccessPrevention) {
     ...
     */
    public IamConfiguration setUniformBucketLevelAccess(
    ...
    public static final class BucketPolicyOnly extends com.google.api.client.json.GenericJson {
      ...
      /**
       * If set, access is controlled only by bucket-level or above IAM policies. The value may be
       * {@code null}.
       */
      @com.google.api.client.util.Key private Boolean enabled;
       ...
       * RFC 3339 format. iamConfiguration.bucketPolicyOnly.enabled may be changed from true to
       * false until the locked time, after which the field is immutable. The value may be {@code
       * null}.
       */
      @com.google.api.client.util.Key private com.google.api.client.util.DateTime lockedTime;
       ...
       * @param enabled enabled or {@code null} for none
       */
      public BucketPolicyOnly setEnabled(Boolean enabled) {
        this.enabled = enabled;
        return this;
      }
    ...
    public static final class UniformBucketLevelAccess
      ...
      /**
       * The deadline for changing iamConfiguration.uniformBucketLevelAccess.enabled from true to
       * false in RFC 3339 format. iamConfiguration.uniformBucketLevelAccess.enabled may be changed
       * from true to false until the locked time, after which the field is immutable. The value may
       * be {@code null}.
       */
      @com.google.api.client.util.Key private com.google.api.client.util.DateTime lockedTime;
       ...
       * @param enabled enabled or {@code null} for none
       */
      public UniformBucketLevelAccess setEnabled(Boolean enabled) {
        this.enabled = enabled;
        return this;
      }
       ...
       * @param lockedTime lockedTime or {@code null} for none
       */
      public UniformBucketLevelAccess setLockedTime(
          com.google.api.client.util.DateTime lockedTime) {
        this.lockedTime = lockedTime;
        return this;
      }
  ...
  public static final class Lifecycle extends com.google.api.client.json.GenericJson {
     ...
     * which the action will be taken. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private java.util.List<Rule> rule;
    ...
    public static final class Rule extends com.google.api.client.json.GenericJson {
      ...
      /** The action to take. The value may be {@code null}. */
      @com.google.api.client.util.Key private Action action;

      /** The condition(s) under which the action will be taken. The value may be {@code null}. */
      @com.google.api.client.util.Key private Condition condition;
      ...
      public static final class Action extends com.google.api.client.json.GenericJson {
        ...
        /**
         * Target storage class. Required iff the type of the action is SetStorageClass. The value
         * may be {@code null}.
         */
        @com.google.api.client.util.Key private String storageClass;
         ...
         * AbortIncompleteMultipartUpload are supported. The value may be {@code null}.
         */
        @com.google.api.client.util.Key private String type;
         ...
         * @param storageClass storageClass or {@code null} for none
         */
        public Action setStorageClass(String storageClass) {
          this.storageClass = storageClass;
          return this;
        }
      ...
      public static final class Condition extends com.google.api.client.json.GenericJson {
         ...
         * specified age. The value may be {@code null}.
         */
        @com.google.api.client.util.Key private Integer age;
         ...
         * UTC. The value may be {@code null}.
         */
        @com.google.api.client.util.Key private com.google.api.client.util.DateTime createdBefore;

        /**
         * A date in RFC 3339 format with only the date part (for instance, "2013-01-15"). This
         * condition is satisfied when the custom time on an object is before this date in UTC. The
         * value may be {@code null}.
         */
        ...
        /**
         * Number of days elapsed since the user-specified timestamp set on an object. The condition
         * is satisfied if the days elapsed is at least this number. If no custom timestamp is
         * specified on an object, the condition does not apply. The value may be {@code null}.
         */
        @com.google.api.client.util.Key private Integer daysSinceCustomTime;

        /**
         * Number of days elapsed since the noncurrent timestamp of an object. The condition is
         * satisfied if the days elapsed is at least this number. This condition is relevant only
         * for versioned objects. The value of the field must be a nonnegative integer. If it's
         * zero, the object version will become eligible for Lifecycle action as soon as it becomes
         * noncurrent. The value may be {@code null}.
         */
        @com.google.api.client.util.Key private Integer daysSinceNoncurrentTime;

        /**
         * Relevant only for versioned objects. If the value is true, this condition matches live
         * objects; if the value is false, it matches archived objects. The value may be {@code
         * null}.
         */
        @com.google.api.client.util.Key private Boolean isLive;

        /**
         * A regular expression that satisfies the RE2 syntax. This condition is satisfied when the
         * name of the object matches the RE2 pattern. Note: This feature is currently in the "Early
         * Access" launch stage and is only available to a whitelisted set of users; that means that
         * this feature may be changed in backward-incompatible ways and that it is not guaranteed
         * to be released. The value may be {@code null}.
         */
        @com.google.api.client.util.Key private String matchesPattern;
         ...
         * DURABLE_REDUCED_AVAILABILITY. The value may be {@code null}.
         */
        @com.google.api.client.util.Key private java.util.List<String> matchesStorageClass;

        /**
         * A date in RFC 3339 format with only the date part (for instance, "2013-01-15"). This
         * condition is satisfied when the noncurrent time on an object is before this date in UTC.
         * This condition is relevant only for versioned objects. The value may be {@code null}.
         */
        @com.google.api.client.util.Key
         ...
         * object. The value may be {@code null}.
         */
        @com.google.api.client.util.Key private Integer numNewerVersions;
         ...
         */
        public Condition setAge(Integer age) {
          this.age = age;
          return this;
        }
        ...
        /**
         * A date in RFC 3339 format with only the date part (for instance, "2013-01-15"). This
         * condition is satisfied when the custom time on an object is before this date in UTC.
         *
         * @return value or {@code null} for none
         */
         ...
         */
        public Condition setDaysSinceCustomTime(Integer daysSinceCustomTime) {
         ...
         */
        public Condition setDaysSinceNoncurrentTime(Integer daysSinceNoncurrentTime) {
         ...
         */
        public Condition setIsLive(Boolean isLive) {
          this.isLive = isLive;
          return this;
        }
         ...
         */
        public Condition setMatchesPattern(String matchesPattern) {
         ...
         * @return value or {@code null} for none
         */
        public java.util.List<String> getMatchesStorageClass() {
         ...
         */
        public Condition setMatchesStorageClass(java.util.List<String> matchesStorageClass) {
         ...
         */
        public Condition setNoncurrentTimeBefore(
            com.google.api.client.util.DateTime noncurrentTimeBefore) {
         ...
         */
        public Condition setNumNewerVersions(Integer numNewerVersions) {
  ...
  public static final class Logging extends com.google.api.client.json.GenericJson {
    ...
    /**
     * The destination bucket where the current bucket's logs should be placed. The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key private String logBucket;

    /** A prefix for log object names. The value may be {@code null}. */
    @com.google.api.client.util.Key private String logObjectPrefix;
     ...
     */
    public Logging setLogBucket(String logBucket) {
     ...
     */
    public Logging setLogObjectPrefix(String logObjectPrefix) {
  ...
  public static final class Owner extends com.google.api.client.json.GenericJson {
    ...
    /** The entity, in the form project-owner-projectId. The value may be {@code null}. */
    @com.google.api.client.util.Key private String entity;

    /** The ID for the entity. The value may be {@code null}. */
     ...
     */
    public Owner setEntity(String entity) {
      this.entity = entity;
      return this;
    }
     ...
     */
    public Owner setEntityId(String entityId) {
  ...
  public static final class RetentionPolicy extends com.google.api.client.json.GenericJson {
     ...
     * This value is in RFC 3339 format. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private com.google.api.client.util.DateTime effectiveTime;

    /**
     * Once locked, an object retention policy cannot be modified. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private Boolean isLocked;
     ...
     * is not guaranteed. Such periods should only be used for testing purposes. The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key @com.google.api.client.json.JsonString
     ...
     */
    public RetentionPolicy setIsLocked(Boolean isLocked) {
     ...
     */
    public RetentionPolicy setRetentionPeriod(Long retentionPeriod) {
  ...
  public static final class Versioning extends com.google.api.client.json.GenericJson {
    ...
    /**
     * While set to true, versioning is fully enabled for this bucket. The value may be {@code
     * null}.
     */
    @com.google.api.client.util.Key private Boolean enabled;
     ...
     * @param enabled enabled or {@code null} for none
     */
    public Versioning setEnabled(Boolean enabled) {
      this.enabled = enabled;
      return this;
    }
  ...
  public static final class Website extends com.google.api.client.json.GenericJson {
     ...
     * index.html objects to represent directory pages. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private String mainPageSuffix;
     ...
     * 404 Not Found result. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private String notFoundPage;
     ...
     */
    public Website setMainPageSuffix(String mainPageSuffix) {
     ...
     */
    public Website setNotFoundPage(String notFoundPage) {
