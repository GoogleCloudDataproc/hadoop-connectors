...
public final class Policy extends com.google.api.client.json.GenericJson {
   ...
   * assume that role. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<Bindings> bindings;
  ...
  /** HTTP 1.1 Entity tag for the policy. The value may be {@code null}. */
   ...
   * input. The value may be {@code null}.
   */
   ...
   * can be denoted with #0. This field is ignored on input. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private String resourceId;

  /** The IAM policy format version. The value may be {@code null}. */
  @com.google.api.client.util.Key private Integer version;
   ...
   */
  public Policy setKind(String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public Policy setResourceId(String resourceId) {
  ...
  public static final class Bindings extends com.google.api.client.json.GenericJson {
     ...
     * examined independently. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private Expr condition;
     ...
     * project. For example, projectViewer:my-example-project The value may be {@code null}.
     */
    @com.google.api.client.util.Key private java.util.List<String> members;

    /**
     * The role to which members belong. Two types of roles are supported: new IAM roles, which
     * grant permissions that do not map directly to those provided by ACLs, and legacy IAM roles,
     * which do map directly to ACL permissions. All roles are of the format
     * roles/storage.specificRole. The new IAM roles are: - roles/storage.admin — Full control of
     * Google Cloud Storage resources. - roles/storage.objectViewer — Read-Only access to Google
     * Cloud Storage objects. - roles/storage.objectCreator — Access to create objects in Google
     * Cloud Storage. - roles/storage.objectAdmin — Full control of Google Cloud Storage objects.
     * The legacy IAM roles are: - roles/storage.legacyObjectReader — Read-only access to objects
     * without listing. Equivalent to an ACL entry on an object with the READER role. -
     ...
     * roles/storage.legacyBucketReader — Read access to buckets with object listing. Equivalent to
     * an ACL entry on a bucket with the READER role. - roles/storage.legacyBucketWriter — Read
     * access to buckets with object listing/creation/deletion. Equivalent to an ACL entry on a
     * bucket with the WRITER role. - roles/storage.legacyBucketOwner — Read and write access to
     * existing buckets with object listing/creation/deletion. Equivalent to an ACL entry on a
     * bucket with the OWNER role. The value may be {@code null}.
     */
     ...
     */
    public Bindings setMembers(java.util.List<String> members) {
     ...
     */
    public Bindings setRole(String role) {
      this.role = role;
      return this;
    }
