...
public final class StorageObject extends com.google.api.client.json.GenericJson {
  ...
  /** Access controls on the object. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<ObjectAccessControl> acl;

  /** The name of the bucket containing this object. The value may be {@code null}. */
   ...
   * anonymous users, the default will be public, max-age=3600. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private String cacheControl;

  /**
   * Number of underlying components that make up this object. Components are accumulated by compose
   * operations. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private Integer componentCount;

  /** Content-Disposition of the object data. The value may be {@code null}. */
  @com.google.api.client.util.Key private String contentDisposition;

  /** Content-Encoding of the object data. The value may be {@code null}. */
  @com.google.api.client.util.Key private String contentEncoding;

  /** Content-Language of the object data. The value may be {@code null}. */
  @com.google.api.client.util.Key private String contentLanguage;

  /**
   * Content-Type of the object data. If an object is stored without a Content-Type, it is served as
   * application/octet-stream. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private String contentType;
   ...
   * Practices. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private String crc32c;

  /**
   * A timestamp in RFC 3339 format specified by the user for an object. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime customTime;

  /**
   * Metadata of customer-supplied encryption key, if the object is encrypted by such a key. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private CustomerEncryption customerEncryption;

  /** HTTP 1.1 Entity tag for the object. The value may be {@code null}. */
   ...
   * hold transitioned from true to false. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private Boolean eventBasedHold;

  /**
   * The content generation of this object. Used for object versioning. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString private Long generation;

  /**
   * The ID of the object, including the bucket name, object name, and generation number. The value
   * may be {@code null}.
   */
  @com.google.api.client.util.Key private String id;

  /**
   * The kind of item this is. For objects, this is always storage#object. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private String kind;

  /**
   * Cloud KMS Key used to encrypt this object, if the object is encrypted by such a key. The value
   * may be {@code null}.
   */
   ...
   * Hashes and ETags: Best Practices. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private String md5Hash;

  /** Media download link. The value may be {@code null}. */
  @com.google.api.client.util.Key private String mediaLink;

  /** User-provided metadata, in key/value pairs. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.Map<String, String> metadata;
   ...
   * particular generation of a particular object. The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private Long metageneration;

  /**
   * The name of the object. Required if not specified by URL parameter. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private String name;

  /**
   * The owner of the object. This will always be the uploader of the object. The value may be
   * {@code null}.
   */
   ...
   * about policy without having to first unset the temporary hold). The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private com.google.api.client.util.DateTime retentionExpirationTime;

  /** The link to this object. The value may be {@code null}. */
  @com.google.api.client.util.Key private String selfLink;

  /** Content-Length of the data in bytes. The value may be {@code null}. */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.math.BigInteger size;

  /** Storage class of the object. The value may be {@code null}. */
   ...
   */
  @com.google.api.client.util.Key private Boolean temporaryHold;

  /** The creation time of the object in RFC 3339 format. The value may be {@code null}. */
   ...
   * version of the object has been deleted. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime timeDeleted;

  /**
   * The time at which the object's storage class was last changed. When the object is initially
   * created, it will be set to timeCreated. The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private com.google.api.client.util.DateTime timeStorageClassUpdated;

  /**
   * The modification time of the object metadata in RFC 3339 format. The value may be {@code null}.
   */
   ...
   */
  public StorageObject setEventBasedHold(Boolean eventBasedHold) {
   ...
   */
  public StorageObject setKmsKeyName(String kmsKeyName) {
   ...
   */
  public StorageObject setMetadata(java.util.Map<String, String> metadata) {
   ...
   */
  public StorageObject setRetentionExpirationTime(
      com.google.api.client.util.DateTime retentionExpirationTime) {
   ...
   */
  public StorageObject setStorageClass(String storageClass) {
   ...
   */
  public StorageObject setTemporaryHold(Boolean temporaryHold) {
   ...
   */
  public StorageObject setTimeStorageClassUpdated(
      com.google.api.client.util.DateTime timeStorageClassUpdated) {
  ...
  public static final class CustomerEncryption extends com.google.api.client.json.GenericJson {
    ...
    /** The encryption algorithm. The value may be {@code null}. */
    @com.google.api.client.util.Key private String encryptionAlgorithm;

    /** SHA256 hash value of the encryption key. The value may be {@code null}. */
    @com.google.api.client.util.Key private String keySha256;
     ...
     */
    public CustomerEncryption setEncryptionAlgorithm(String encryptionAlgorithm) {
     ...
     */
    public CustomerEncryption setKeySha256(String keySha256) {
  ...
  public static final class Owner extends com.google.api.client.json.GenericJson {
    ...
    /** The entity, in the form user-userId. The value may be {@code null}. */
