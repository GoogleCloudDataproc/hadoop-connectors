...
public final class ComposeRequest extends com.google.api.client.json.GenericJson {
  ...
  /** Properties of the resulting object. The value may be {@code null}. */
  @com.google.api.client.util.Key private StorageObject destination;

  /** The kind of item this is. The value may be {@code null}. */
  @com.google.api.client.util.Key private String kind;

  /**
   * The list of source objects that will be concatenated into a single object. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<SourceObjects> sourceObjects;

  static {
    // hack to force ProGuard to consider SourceObjects used, since otherwise it would be stripped
    // out
   ...
   */
  public ComposeRequest setKind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public static final class SourceObjects extends com.google.api.client.json.GenericJson {
    ...
    /** The generation of this object to use as the source. The value may be {@code null}. */
    @com.google.api.client.util.Key @com.google.api.client.json.JsonString private Long generation;

    /**
     * The source object's name. All source objects must reside in the same bucket. The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key private String name;

    /** Conditions that must be met for this operation to execute. The value may be {@code null}. */
    @com.google.api.client.util.Key private ObjectPreconditions objectPreconditions;
     ...
     */
    public SourceObjects setGeneration(Long generation) {
     ...
     */
    public SourceObjects setName(String name) {
      this.name = name;
      return this;
    }
    ...
    public static final class ObjectPreconditions extends com.google.api.client.json.GenericJson {
       ...
       * same value or the call will fail. The value may be {@code null}.
       */
       ...
       */
      public ObjectPreconditions setIfGenerationMatch(Long ifGenerationMatch) {
