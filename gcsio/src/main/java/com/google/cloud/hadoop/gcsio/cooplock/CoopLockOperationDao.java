...
public class CoopLockOperationDao {
    ...
    private final ScheduledExecutorService scheduledThreadPool =
            Executors.newScheduledThreadPool(
                    ...
                    new ThreadFactoryBuilder()
                            .setNameFormat("coop-lock-thread-%d")
                            .setDaemon(true)
                            .build());
    ...
    public void checkpointRenameOperation(
        ...
        throw new IOException(
                String.format(
                        "Failed to checkpoint '%s' lock for %s operation",
    ...
    private void modifyOperationLock(
        ...
        StorageResourceId lockIdWithGeneration =
                new StorageResourceId(
                        lockId.getBucketName(),
                        lockId.getObjectName(),
    ...
    private URI writeOperationFile(
        ...
        URI path =
                getOperationFilePath(
                        bucket, fileNameFormat, operationType, operationId, operationInstant);
        StorageResourceId resourceId =
    ...
    private URI getOperationFilePath(
        ...
        String file =
                String.format(LOCK_DIRECTORY + fileNameFormat, date, operationType, operationId);
    ...
    public <T> Future<?> scheduleLockUpdate(
        ...
        long lockRenewTimeoutMilli =
                Math.min(
                        options.getLockExpirationTimeoutMilli() / 4, MAX_LOCK_RENEW_TIMEOUT_MILLIS);
