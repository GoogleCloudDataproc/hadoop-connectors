...
public class FileInfo {
    ...
    public String toString() {
        return getPath()
                + (exists() ? ": created on: " + new Date(getCreationTime()) : ": exists: no");
    }
     ...
     * potentially returning a singleton instead of really constructing an object for cases like
     * ROOT.
     */
    public static FileInfo fromItemInfo(GoogleCloudStorageItemInfo itemInfo) {
        ...
        URI path =
                UriPaths.fromResourceId(itemInfo.getResourceId(), /* allowEmptyObjectName= */ true);
