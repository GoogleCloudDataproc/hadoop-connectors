...
public class ForwardingGoogleCloudStorage implements GoogleCloudStorage {
  ...
  public GoogleCloudStorageOptions getOptions() {
    logger.atInfo().log("%s.getOptions()", delegateClassName);
  ...
  public WritableByteChannel create(StorageResourceId resourceId, CreateObjectOptions options)
      throws IOException {
    logger.atInfo().log("%s.create(%s, %s)", delegateClassName, resourceId, options);
  ...
  public void createBucket(String bucketName, CreateBucketOptions options) throws IOException {
    logger.atInfo().log("%s.createBucket(%s, %s)", delegateClassName, bucketName, options);
    delegate.createBucket(bucketName, options);
  }

  @Override
  public void createEmptyObject(StorageResourceId resourceId) throws IOException {
    logger.atInfo().log("%s.createEmptyObject(%s)", delegateClassName, resourceId);
  ...
  public void createEmptyObject(StorageResourceId resourceId, CreateObjectOptions options)
      throws IOException {
    logger.atInfo().log("%s.createEmptyObject(%s, %s)", delegateClassName, resourceId, options);
  ...
  public void createEmptyObjects(List<StorageResourceId> resourceIds) throws IOException {
    logger.atInfo().log("%s.createEmptyObjects(%s)", delegateClassName, resourceIds);
  ...
  public void createEmptyObjects(List<StorageResourceId> resourceIds, CreateObjectOptions options)
      throws IOException {
    logger.atInfo().log("%s.createEmptyObjects(%s, %s)", delegateClassName, resourceIds, options);
  ...
  public SeekableByteChannel open(
    ...
    logger.atInfo().log("%s.open(%s, %s)", delegateClassName, resourceId, readOptions);
  ...
  public SeekableByteChannel open(
      ...
      throws IOException {
    logger.atInfo().log("%s.open(%s, %s)", delegateClassName, itemInfo, readOptions);
    return delegate.open(itemInfo, readOptions);
  }

  @Override
  public void deleteBuckets(List<String> bucketNames) throws IOException {
    logger.atInfo().log("%s.deleteBuckets(%s)", delegateClassName, bucketNames);
    delegate.deleteBuckets(bucketNames);
  }

  @Override
  public void deleteObjects(List<StorageResourceId> fullObjectNames) throws IOException {
    logger.atInfo().log("%s.deleteObjects(%s)", delegateClassName, fullObjectNames);
  ...
  public void deleteFolders(List<FolderInfo> folders) throws IOException {
    logger.atInfo().log("%s.deleteFolders(%s)", delegateClassName, folders);
  ...
  public void copy(Map<StorageResourceId, StorageResourceId> sourceToDestinationObjectsMap)
      throws IOException {
    logger.atInfo().log("%s.copy(%s)", delegateClassName, sourceToDestinationObjectsMap);
  ...
  public void move(Map<StorageResourceId, StorageResourceId> sourceToDestinationObjectsMap)
      throws IOException {
    logger.atInfo().log("%s.move(%s)", delegateClassName, sourceToDestinationObjectsMap);
  ...
  public List<String> listBucketNames() throws IOException {
    logger.atInfo().log("%s.listBucketNames()", delegateClassName);
  ...
  public List<GoogleCloudStorageItemInfo> listBucketInfo() throws IOException {
    logger.atInfo().log("%s.listBucketInfo()", delegateClassName);
  ...
  public GoogleCloudStorageItemInfo getItemInfo(StorageResourceId resourceId) throws IOException {
    logger.atInfo().log("%s.getItemInfo(%s)", delegateClassName, resourceId);
  ...
  public List<GoogleCloudStorageItemInfo> getItemInfos(List<StorageResourceId> resourceIds)
      throws IOException {
    logger.atInfo().log("%s.getItemInfos(%s)", delegateClassName, resourceIds);
  ...
  public List<GoogleCloudStorageItemInfo> updateItems(List<UpdatableItemInfo> itemInfoList)
      throws IOException {
    logger.atInfo().log("%s.updateItems(%s)", delegateClassName, itemInfoList);
    return delegate.updateItems(itemInfoList);
  }

  @Override
  public void close() {
    logger.atInfo().log("%s.close()", delegateClassName);
    delegate.close();
  }
