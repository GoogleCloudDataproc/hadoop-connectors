...
public class TrackingHttpRequestInitializerFromGcsio implements HttpRequestInitializer {
    ...
    public TrackingHttpRequestInitializerFromGcsio() {
        this(/* delegate= */ null);
    }

    public TrackingHttpRequestInitializerFromGcsio(HttpRequestInitializer delegate) {
        this(delegate, /* replaceRequestParams= */ true);
    }

    public TrackingHttpRequestInitializerFromGcsio(boolean replaceRequestParams) {
    ...
    public ImmutableList<String> getAllRequestStrings() {
        ...
        return requests.stream()
                .map(TrackingHttpRequestInitializerFromGcsio::requestToString)
