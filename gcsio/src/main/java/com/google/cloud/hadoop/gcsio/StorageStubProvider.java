...
class StorageStubProvider {
    ...
    static class DirectPathGrpcDecorator implements GrpcDecorator {
        ...
        private Map<String, Object> getGrpcServiceConfig() {
                            ...
                            .put(
                                    ...
                                    Durations.toString(
                                            Durations.fromMillis(
                                                    readOptions.getBackoffInitialIntervalMillis())))
                            .put(
                                    "maxBackoff",
                                    Durations.toString(
                                            Durations.fromMillis(
                                                    readOptions.getBackoffMaxIntervalMillis())))
            ...
            Map<String, Object> pickFirstStrategy =
        ...
        boolean useDirectpath =
                options.isDirectPathPreffered()
                        ...
                        && java.util.Objects.equals(
                                ...
                                ComputeCredential.TOKEN_SERVER_ENCODED_URL);
