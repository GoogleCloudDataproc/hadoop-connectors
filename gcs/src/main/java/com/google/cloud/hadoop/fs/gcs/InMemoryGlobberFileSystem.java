    ...
    for (FileStatus fileStatus : fileStatuses) {
      ...
      if (fileStatus.getPath().getParent() != null) {
        List<FileStatus> children =
            this.fileStatusesByParentPath.get(fileStatus.getPath().getParent());
        if (children == null) {
          children = new ArrayList<>();
          this.fileStatusesByParentPath.put(fileStatus.getPath().getParent(), children);
        }
        children.add(fileStatus);
      }
    }
  }
