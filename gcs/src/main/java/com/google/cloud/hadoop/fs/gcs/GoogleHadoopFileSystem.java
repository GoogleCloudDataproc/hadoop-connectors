...
import static com.google.cloud.hadoop.fs.gcs.GoogleHadoopFileSystemConfiguration.GCS_ANALYTICS_WRITE_ENABLE;
...
public class GoogleHadoopFileSystem extends FileSystem implements IOStatisticsSource {
  ...
  boolean isAnalyticsWriteEnabled() {
    return GCS_ANALYTICS_WRITE_ENABLE.get(getConf(), getConf()::getBoolean);
  }
