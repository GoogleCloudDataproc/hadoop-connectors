 ...
 *
 * <p>HDFS tests use an instance of this class as-is. Other tests (eg, GHFS tests) may override
 * parts of the behavior methods if the corresponding FS' behavior differs from that of HDFS. It
 * allows us to easily identify deviation of behavior of a file system from that of HDFS.
 */
