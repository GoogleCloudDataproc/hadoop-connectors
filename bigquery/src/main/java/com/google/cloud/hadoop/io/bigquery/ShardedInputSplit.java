...
/**
 * ShardedInputSplit implements Hadoop InputSplit by storing path information for a logical "shard"
 * corresponding to a single Hadoop task. This shard will own a single subdirectory of GCS so read
 * in dynamic ordering as a BigQuery export proceeds simultaneously.
 */
