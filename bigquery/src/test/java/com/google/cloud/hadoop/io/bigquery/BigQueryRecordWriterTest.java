...
public class BigQueryRecordWriterTest {
  ...
  public void setUp() throws IOException, GeneralSecurityException {
    ...
    jobReference.set("location", "test_location");
    ...
    when(mockJobsGet.set(eq("location"), any(String.class))).thenReturn(mockJobsGet);
  ...
  public void testSingleWrite() throws IOException, GeneralSecurityException {
    ...
    verify(mockJobsGet).set(eq("location"), eq("test_location"));
