...
1. All BigQuery job insertions now supply client-generated job_ids and handle 409 conflict as a
...
1. Eliminated the need to call `BigQueryInputFormat.setInputs(Job)` in main class; this is now
